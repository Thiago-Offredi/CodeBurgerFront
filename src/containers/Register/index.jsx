...
export function Register() {
    ...
    const schema = Yup.object().shape({
        name: Yup.string().required('Digite seu nome, é obrigatório'),
    ...
    return (
        <Container>
            ...
            <ContainerItens>
                <img src={Logo} className="logo-code-burger" alt="Logo-code-burger" />
                <h1>Cadastra-se</h1>
                ...
                <SignInLink>
                    Já possui conta ?  <Link style={{ color: 'white' }} to="/">Sign In</Link>
                </SignInLink>
            </ContainerItens>
        </Container>
    )
